...
* Студент: [Студентище Неопознанный](http://up.htmlacademy.local/htmlcss/18/user/508015).
* Наставник: `Test2`.
...
[Откройте мастер-репозиторий](https://github.com/optimus-htmlcss/508015-device) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
